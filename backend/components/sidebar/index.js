            ...
            <div className="sidebar">
              ...
              <div className="sidebar__middle">
                <ul className="sidebar__nav">
                  <li className="sidebar__nav-item"><a className="sidebar__nav-link" href="" data-id="1">
                      ...
                      </div><span className="sidebar__nav-link-title">Кальяны</span>
                      <div className="sidebar__nav-link-arr">
                        <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 15L7.94911 7.674L1 1" strokeWidth="1.5" strokeLinejoin="round"></path>
                        </svg>
                      </div></a>
                    <div className="sidebar__menu">
                      <ul className="sidebar__menu-list">
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Maklaud</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Alpha hookah</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Shi carver</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Capsule</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Nube </a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Сwp  </a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Mamay</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Ferro</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Darkside </a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Душа</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Gramm</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Hub</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Geometry</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Nuahule (хулиган)</a></li>
                        <li className="sidebar__menu-item"> <a className="sidebar__menu-link" href="">Union</a></li>
                      </ul>
                      <div className="sidebar__menu-img"> <img src="/static/img/sidebar-menu-img.png" alt="" /></div>
                    </div>
                  </li>
                  <li className="sidebar__nav-item"><a className="sidebar__nav-link" href="" data-id="2">
                      <div className="sidebar__nav-link-icon">
                      ...
                      </div><span className="sidebar__nav-link-title">Аксессуары</span>
                      <div className="sidebar__nav-link-arr">
                        <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 15L7.94911 7.674L1 1" strokeWidth="1.5" strokeLinejoin="round"></path>
                        </svg>
                  ...
                  <li className="sidebar__nav-item"><a className="sidebar__nav-link" href="" data-id="3">
                      <div className="sidebar__nav-link-icon">
                      ...
                      </div><span className="sidebar__nav-link-title">Табак</span>
                      <div className="sidebar__nav-link-arr">
                        <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 15L7.94911 7.674L1 1" strokeWidth="1.5" strokeLinejoin="round"></path>
                        </svg>
                  ...
                  <li className="sidebar__nav-item"><a className="sidebar__nav-link" href="" data-id="4">
                      <div className="sidebar__nav-link-icon">
                      ...
                      </div><span className="sidebar__nav-link-title">Уголь</span>
                      <div className="sidebar__nav-link-arr">
                        <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 15L7.94911 7.674L1 1" strokeWidth="1.5" strokeLinejoin="round"></path>
                        </svg>
              ...
              <div className="sidebar__bot">
                <ul className="sidebar__page-nav">
                  <li className="sidebar__page-nav-item"><a className="sidebar__page-nav-link" href="">Доставка и оплата</a></li>
                  <li className="sidebar__page-nav-item"><a className="sidebar__page-nav-link" href="">Блог</a></li>
                  <li className="sidebar__page-nav-item"><a className="sidebar__page-nav-link" href="">Контакты</a></li>
                </ul>
                <ul className="socials">
                  <li className="socials__item"><a className="socials__item-link" href="">
